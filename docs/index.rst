...
* `GRX <http://www.ev3dev.org/grx>`_ - graphics library (GObject Introspection)

* `ev3devKit <http://www.ev3dev.org/ev3devKit>`_ - graphical widgets and hardware interface library (GObject Introspection)
