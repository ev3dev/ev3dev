Release notes for ev3dev-jessie-2015-03-31.img
==============================================

Changes from previous version
-----------------------------
*   Fixed issue with duplicate volume groups when flashing image over existing install.
    See [issue #267](https://github.com/ev3dev/ev3dev/issues/267).
...
ii  apt                                   1.0.9.7                                            armel        commandline package manager
...
ii  brickman                              0.5.1                                              armel        ev3dev Brick Manager
...
ii  console-setup                         1.119                                              all          console font and keymap setup program
ii  console-setup-linux                   1.119                                              all          Linux specific part of console-setup
...
ii  dmeventd                              2:1.02.90-2.1                                      armel        Linux Kernel Device Mapper event daemon
ii  dmsetup                               2:1.02.90-2.1                                      armel        Linux Kernel Device Mapper userspace library
ii  dosfstools                            3.0.27-1                                           armel        utilities for making and checking MS-DOS FAT filesystems
ii  dpkg                                  1.17.24                                            armel        Debian package management system
...
ii  flash-kernel                          3.33                                               armel        utility to make certain embedded devices bootable
...
ii  initramfs-tools                       0.119                                              all          generic modular initramfs generator
...
ii  keyboard-configuration                1.119                                              all          system-wide keyboard preferences
...
ii  libapt-pkg4.12:armel                  1.0.9.7                                            armel        package management runtime library
...
ii  libc-bin                              2.19-15                                            armel        GNU C Library: Binaries
ii  libc-dev-bin                          2.19-15                                            armel        GNU C Library: Development binaries
ii  libc6:armel                           2.19-15                                            armel        GNU C Library: Shared libraries
ii  libc6-dev:armel                       2.19-15                                            armel        GNU C Library: Development Libraries and Header Files
ii  libcap-ng0:armel                      0.7.4-2                                            armel        An alternate POSIX capabilities library
ii  libcap2:armel                         1:2.24-7                                           armel        POSIX 1003.1e capabilities (library)
ii  libcap2-bin                           1:2.24-7                                           armel        POSIX 1003.1e capabilities (utilities)
...
ii  libdevmapper-event1.02.1:armel        2:1.02.90-2.1                                      armel        Linux Kernel Device Mapper event support library
ii  libdevmapper1.02.1:armel              2:1.02.90-2.1                                      armel        Linux Kernel Device Mapper userspace library
...
ii  libgudev-1.0-0:armel                  215-12                                             armel        GObject-based wrapper library for libudev
...
ii  liblvm2cmd2.02:armel                  2.02.111-2.1                                       armel        LVM2 command library
...
ii  libsystemd0:armel                     215-12                                             armel        systemd utility library
...
ii  libtiff5:armel                        4.0.3-12.2                                         armel        Tag Image File Format (TIFF) library
...
ii  libudev1:armel                        215-12                                             armel        libudev shared library
...
ii  linux-libc-dev:armel                  3.16.7-ckt7-1                                      armel        Linux support headers for userspace development
ii  locales                               2.19-15                                            all          GNU C Library: National Language (locale) data [support]
...
ii  lvm2                                  2.02.111-2.1                                       armel        Linux Logical Volume Manager
...
ii  multiarch-support                     2.19-15                                            armel        Transitional package to ensure multiarch compatibility
...
ii  perl                                  5.20.2-2                                           armel        Larry Wall's Practical Extraction and Report Language
ii  perl-base                             5.20.2-2                                           armel        minimal Perl system
...
ii  systemd                               215-12                                             armel        system and service manager
ii  systemd-sysv                          215-12                                             armel        system and service manager - SysV links
...
ii  u-boot-tools                          2014.10+dfsg1-4                                    armel        companion tools for Das U-Boot bootloader
ii  ucf                                   3.0030                                             all          Update Configuration File(s): preserve user changes to config files
ii  udev                                  215-12                                             armel        /dev/ and hotplug management daemon
ii  usbutils                              1:007-2                                            armel        Linux USB utilities
ii  util-linux                            2.25.2-5                                           armel        Miscellaneous system utilities
ii  vim                                   2:7.4.488-6                                        armel        Vi IMproved - enhanced vi editor
ii  vim-common                            2:7.4.488-6                                        armel        Vi IMproved - Common files
ii  vim-runtime                           2:7.4.488-6                                        all          Vi IMproved - Runtime files
