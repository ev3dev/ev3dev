Release notes for rpi2-ev3dev-jessie-2015-12-30.img
==============================================

Changes from previous version
-----------------------------

* Default user:password is now robot:maker
* Fixed file permission issues
* ev3dev kernel 4.1.15-9-ev3dev-rpi2
* Support for PiStorms
* Updated ev3dev packages
* New packages: brickman, bsdmainnutils, evtest, fbset, firmware-linux-free, openrobertalab,
  python-ev3dev, python-evdev, python-setuptools
* Removed packages: dphys-swapfile, golang-go
...
ii  bind9-host                       1:9.9.5.dfsg-9+deb8u2             armhf        Version of 'host' bundled with BIND 9.X
...
ii  brickpi-systemd                  3                                 all          Udev rule and systemd service for BrickPi.
...
ii  ev3devkit-data                   0.3.1                             all          Programming toolkit for ev3dev
...
ii  flash-kernel                     3.35ev3dev6                       armhf        utility to make certain embedded devices bootable
...
ii  isc-dhcp-client                  4.3.1-6                           armhf        DHCP client for automatically obtaining an IP address
ii  isc-dhcp-common                  4.3.1-6                           armhf        common files used by all of the isc-dhcp packages
...
ii  libapt-pkg4.12:armhf             1.0.9.8.1                         armhf        package management runtime library
...
ii  libbind9-90                      1:9.9.5.dfsg-9+deb8u2             armhf        BIND9 Shared Library used by BIND
...
ii  libc-bin                         2.19-18+deb8u1                    armhf        GNU C Library: Binaries
ii  libc-dev-bin                     2.19-18+deb8u1                    armhf        GNU C Library: Development binaries
ii  libc6:armhf                      2.19-18+deb8u1                    armhf        GNU C Library: Shared libraries
ii  libc6-dev:armhf                  2.19-18+deb8u1                    armhf        GNU C Library: Development Libraries and Header Files
...
ii  libdns-export100                 1:9.9.5.dfsg-9+deb8u2             armhf        Exported DNS Shared Library
ii  libdns100                        1:9.9.5.dfsg-9+deb8u2             armhf        DNS Shared Library used by BIND
...
ii  libev3devkit-0.3-0               0.3.1                             armhf        Programming toolkit for ev3dev
...
ii  libfreetype6:armhf               2.5.2-3                           armhf        FreeType 2 font engine, shared library files
...
ii  libgudev-1.0-0:armhf             215-17+deb8u2                     armhf        GObject-based wrapper library for libudev
...
ii  libicu52:armhf                   52.1-8+deb8u2                     armhf        International Components for Unicode
ii  libidn11:armhf                   1.29-1+b2                         armhf        GNU Libidn library, implementation of IETF IDN specifications
ii  libirs-export91                  1:9.9.5.dfsg-9+deb8u2             armhf        Exported IRS Shared Library
ii  libisc-export95                  1:9.9.5.dfsg-9+deb8u2             armhf        Exported ISC Shared Library
ii  libisc95                         1:9.9.5.dfsg-9+deb8u2             armhf        ISC Shared Library used by BIND
ii  libisccc90                       1:9.9.5.dfsg-9+deb8u2             armhf        Command Channel Library used by BIND
ii  libisccfg-export90               1:9.9.5.dfsg-9+deb8u2             armhf        Exported ISC CFG Shared Library
ii  libisccfg90                      1:9.9.5.dfsg-9+deb8u2             armhf        Config File Handling Library used by BIND
...
ii  libldb1:armhf                    2:1.1.17-2                        armhf        LDAP-like embedded database - shared library
...
ii  liblwres90                       1:9.9.5.dfsg-9+deb8u2             armhf        Lightweight Resolver Library used by BIND
...
ii  libpam-modules:armhf             1.1.8-3.1                         armhf        Pluggable Authentication Modules for PAM
ii  libpam-modules-bin               1.1.8-3.1                         armhf        Pluggable Authentication Modules for PAM - helper binaries
ii  libpam-runtime                   1.1.8-3.1                         all          Runtime support for the PAM library
ii  libpam-systemd:armhf             215-17+deb8u2                     armhf        system and service manager - PAM module
...
ii  libpng12-0:armhf                 1.2.50-2+b2                       armhf        PNG library - runtime
...
ii  libraspberrypi-bin               1.20151215-1ev3dev1               armhf        Miscellaneous Raspberry Pi utilities
ii  libraspberrypi0                  1.20151215-1ev3dev1               armhf        EGL/GLES/OpenVG/etc. libraries for the Raspberry Pi's VideoCore IV
...
ii  libsasl2-2:armhf                 2.1.26.dfsg1-13                   armhf        Cyrus SASL - authentication abstraction library
ii  libsasl2-modules-db:armhf        2.1.26.dfsg1-13                   armhf        Cyrus SASL - pluggable authentication modules (DB)
...
ii  libsmbclient:armhf               2:4.1.17+dfsg-2                   armhf        shared library for communication with SMB/CIFS servers
...
ii  libssl-dev:armhf                 1.0.1k-3+deb8u1                   armhf        Secure Sockets Layer toolkit - development files
ii  libssl1.0.0:armhf                1.0.1k-3+deb8u1                   armhf        Secure Sockets Layer toolkit - shared libraries
...
ii  libudev1:armhf                   215-17+deb8u2                     armhf        libudev shared library
...
ii  libwbclient0:armhf               2:4.1.17+dfsg-2                   armhf        Samba winbind client library
...
ii  linux-image-4.1.15-9-ev3dev-rpi2 1                                 armhf        Linux kernel binary image for version 4.1.15-9-ev3dev-rpi2
ii  linux-image-ev3dev-rpi2          4                                 armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
...
ii  multiarch-support                2.19-18+deb8u1                    armhf        Transitional package to ensure multiarch compatibility
...
ii  ntp                              1:4.2.6.p5+dfsg-7                 armhf        Network Time Protocol daemon and utility programs
ii  openrobertalab                   1.3.2+1.0.0                       all          lab.open-roberta.org connector for ev3dev.org
ii  openssh-client                   1:6.7p1-5                         armhf        secure shell (SSH) client, for secure access to remote machines
ii  openssh-server                   1:6.7p1-5                         armhf        secure shell (SSH) server, for secure access from remote machines
ii  openssh-sftp-server              1:6.7p1-5                         armhf        secure shell (SSH) sftp server module, for SFTP access from remote machines
...
ii  passwd                           1:4.2-3                           armhf        change and administer password and group data
ii  perl                             5.20.2-3+deb8u1                   armhf        Larry Wall's Practical Extraction and Report Language
ii  perl-base                        5.20.2-3+deb8u1                   armhf        minimal Perl system
...
ii  python-ldb                       2:1.1.17-2                        armhf        Python bindings for LDB
...
ii  python-samba                     2:4.1.17+dfsg-2                   armhf        Python bindings for Samba
...
ii  raspberrypi-bootloader           1.20151215-1ev3dev1               armhf        Raspberry Pi bootloader
ii  readline-common                  6.3-8                             all          GNU readline and history libraries, common files
ii  rpcbind                          0.2.1-6                           armhf        converts RPC program numbers into universal addresses
ii  rpi-mkimage                      20150602                          all          Tool to add "trailer" to device-tree capable Raspberry Pi kernels.
...
ii  screen                           4.2.1-3                           armhf        terminal multiplexer with VT100/ANSI terminal emulation
...
ii  sudo                             1.8.10p3-1+deb8u2                 armhf        Provide limited super user privileges to specific users
...
ii  udev                             215-17+deb8u2                     armhf        /dev/ and hotplug management daemon
...
ii  wpasupplicant                    2.3-1+deb8u1                      armhf        client support for WPA and WPA2 (IEEE 802.11i)
