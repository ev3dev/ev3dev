Release notes for ev3dev-jessie-ev3-generic-2016-10-17.img
==========================================================

Changes from previous version
-----------------------------
* Based on Debian Jessie 8.6
* ev3dev kernel 4.4.24-16-ev3dev-ev3
...
ii  bind9-host                             1:9.9.5.dfsg-9+deb8u7     armel        Version of 'host' bundled with BIND 9.X
...
ii  libbind9-90                            1:9.9.5.dfsg-9+deb8u7     armel        BIND9 Shared Library used by BIND
...
ii  libcurl3-gnutls:armel                  7.38.0-4+deb8u4           armel        easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii  libdns-export100                       1:9.9.5.dfsg-9+deb8u7     armel        Exported DNS Shared Library
ii  libdns100                              1:9.9.5.dfsg-9+deb8u7     armel        DNS Shared Library used by BIND
...
ii  libicu52:armel                         52.1-8+deb8u3             armel        International Components for Unicode
...
ii  libirs-export91                        1:9.9.5.dfsg-9+deb8u7     armel        Exported IRS Shared Library
ii  libisc-export95                        1:9.9.5.dfsg-9+deb8u7     armel        Exported ISC Shared Library
ii  libisc95                               1:9.9.5.dfsg-9+deb8u7     armel        ISC Shared Library used by BIND
ii  libisccc90                             1:9.9.5.dfsg-9+deb8u7     armel        Command Channel Library used by BIND
ii  libisccfg-export90                     1:9.9.5.dfsg-9+deb8u7     armel        Exported ISC CFG Shared Library
ii  libisccfg90                            1:9.9.5.dfsg-9+deb8u7     armel        Config File Handling Library used by BIND
...
ii  liblwres90                             1:9.9.5.dfsg-9+deb8u7     armel        Lightweight Resolver Library used by BIND
...
ii  libsmbclient:armel                     2:4.2.10+dfsg-0+deb8u3    armel        shared library for communication with SMB/CIFS servers
...
ii  libtevent0:armel                       0.9.25-0+deb8u1           armel        talloc-based event loop library - shared library
...
ii  libwbclient0:armel                     2:4.2.10+dfsg-0+deb8u3    armel        Samba winbind client library
...
ii  linux-image-4.4.24-16-ev3dev-ev3       1                         armel        Linux kernel binary image for version 4.4.24-16-ev3dev-ev3
ii  linux-image-ev3dev-ev3                 31                        armel        Linux kernel for ev3dev (meta-package)
ii  linux-libc-dev:armel                   3.16.36-1+deb8u1          armel        Linux support headers for userspace development
...
ii  python-bluez                           0.22-1ev3dev1             armel        Python wrappers around BlueZ for rapid bluetooth development
...
ii  python-pil:armel                       2.6.1-2+deb8u2            armel        Python Imaging Library (Pillow fork)
...
ii  python-samba                           2:4.2.10+dfsg-0+deb8u3    armel        Python bindings for Samba
...
ii  python3-pil:armel                      2.6.1-2+deb8u2            armel        Python Imaging Library (Python3)
...
ii  rtl8188eu-modules-4.4.24-16-ev3dev-ev3 5+1                       armel        rtl8188eu modules for Linux (kernel 4.4.24-16-ev3dev-ev3).
...
ii  samba                                  2:4.2.10+dfsg-0+deb8u3    armel        SMB/CIFS file, print, and login server for Unix
ii  samba-common                           2:4.2.10+dfsg-0+deb8u3    all          common files used by both the Samba server and client
ii  samba-common-bin                       2:4.2.10+dfsg-0+deb8u3    armel        Samba common files used by both the server and the client
ii  samba-dsdb-modules                     2:4.2.10+dfsg-0+deb8u3    armel        Samba Directory Services Database
ii  samba-libs:armel                       2:4.2.10+dfsg-0+deb8u3    armel        Samba core libraries
