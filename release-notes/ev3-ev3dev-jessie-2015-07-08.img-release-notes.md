Release notes for ev3-ev3dev-jessie-2015-07-08.img
==============================================

Changes from previous version
-----------------------------

* Updated packages from Debian 8.1 point release.
* ev3dev kernel 3.16.7-ckt14-6-ev3dev-ev3
...
ii  dbus                                  1.8.18-0+deb8u1          armel        simple interprocess messaging system (daemon and utilities)
...
ii  libdbus-1-3:armel                     1.8.18-0+deb8u1          armel        simple interprocess messaging system (library)
...
ii  libgnutls-deb0-28:armel               3.3.8-6+deb8u1           armel        GNU TLS library - main runtime library
ii  libgnutls-openssl27:armel             3.3.8-6+deb8u1           armel        GNU TLS library - OpenSSL wrapper
...
ii  libgudev-1.0-0:armel                  215-17+deb8u1            armel        GObject-based wrapper library for libudev
...
ii  libpam-systemd:armel                  215-17+deb8u1            armel        system and service manager - PAM module
...
ii  libruby2.1:armel                      2.1.5-2+deb8u1           armel        Libraries necessary to run Ruby 2.1
...
ii  libsystemd0:armel                     215-17+deb8u1            armel        systemd utility library
...
ii  libudev1:armel                        215-17+deb8u1            armel        libudev shared library
...
ii  linux-image-3.16.7-ckt14-6-ev3dev-ev3 1                        armel        Linux kernel binary image for version 3.16.7-ckt14-6-ev3dev-ev3
ii  linux-image-ev3dev-ev3                21                       armel        Linux kernel for ev3dev (meta-package)
ii  linux-libc-dev:armel                  3.16.7-ckt11-1           armel        Linux support headers for userspace development
...
ii  ruby2.1                               2.1.5-2+deb8u1           armel        Interpreter of object-oriented scripting language Ruby
...
ii  systemd                               215-17+deb8u1            armel        system and service manager
ii  systemd-sysv                          215-17+deb8u1            armel        system and service manager - SysV links
...
ii  udev                                  215-17+deb8u1            armel        /dev/ and hotplug management daemon
