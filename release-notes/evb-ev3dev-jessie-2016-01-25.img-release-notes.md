Release notes for evb-ev3dev-jessie-2016-01-25.img
==================================================

Known issues
------------
* Some packages are not published on the ev3dev.org repository.
* Automatic detection of NXT sensors does not work properly (hardware limitation).
* I2C sensors do not work.
* No drivers for rtl8192cu (e.g. Edimax EW-7811Un).

Built using
-----------
* elementary OS Freya
* brickstrap <unreleased hacked version>
* libguestfs-tools 1:1.24.5-1ubuntu0.1
* multistrap 2.2.0ubuntu2
* qemu-user-static 1:2.3+dfsg-5ubuntu9.1
...
ii  apt                                            1.0.9.8.2                         armhf        commandline package manager
ii  avahi-daemon                                   0.6.31-5                          armhf        Avahi mDNS/DNS-SD daemon
ii  base-files                                     8ev3dev1                          armhf        Debian base system miscellaneous files
...
ii  bind9-host                                     1:9.9.5.dfsg-9+deb8u4             armhf        Version of 'host' bundled with BIND 9.X
ii  bluez                                          5.23-2+b1                         armhf        Bluetooth tools and daemons
ii  brickman                                       0.7.2                             armhf        ev3dev Brick Manager
...
ii  connman                                        1.31-0ev3dev1                     armhf        Intel Connection Manager daemon
...
ii  cpio                                           2.11+dfsg-4.1                     armhf        GNU cpio -- a program to manage archives of files
ii  dash                                           0.5.7-4+b1                        armhf        POSIX-compliant shell
ii  dbus                                           1.8.20-0+deb8u1                   armhf        simple interprocess messaging system (daemon and utilities)
...
ii  dmsetup                                        2:1.02.90-2.2                     armhf        Linux Kernel Device Mapper userspace library
ii  dosfstools                                     3.0.27-1                          armhf        utilities for making and checking MS-DOS FAT filesystems
ii  dpkg                                           1.17.26                           armhf        Debian package management system
...
ii  ev3devkit-data                                 0.3.2                             all          Programming toolkit for ev3dev
ii  evb-systemd                                    1                                 armhf        Systemd unit files and udev rules for FatcatLab's EVB.
...
ii  flash-kernel                                   3.35ev3dev7~3                     armhf        utility to make certain embedded devices bootable
ii  fuse                                           2.9.3-15+deb8u1                   armhf        Filesystem in Userspace
...
iF  initramfs-tools                                0.120                             all          generic modular initramfs generator
...
ii  libapt-pkg4.12:armhf                           1.0.9.8.2                         armhf        package management runtime library
...
ii  libbind9-90                                    1:9.9.5.dfsg-9+deb8u4             armhf        BIND9 Shared Library used by BIND
...
ii  libc-ares-dev:armhf                            1.10.0-2                          armhf        asynchronous name resolver - development files
ii  libc-ares2:armhf                               1.10.0-2                          armhf        asynchronous name resolver
ii  libc-bin                                       2.19-18+deb8u2                    armhf        GNU C Library: Binaries
ii  libc-dev-bin                                   2.19-18+deb8u2                    armhf        GNU C Library: Development binaries
ii  libc6:armhf                                    2.19-18+deb8u2                    armhf        GNU C Library: Shared libraries
ii  libc6-dev:armhf                                2.19-18+deb8u2                    armhf        GNU C Library: Development Libraries and Header Files
...
ii  libdbus-1-3:armhf                              1.8.20-0+deb8u1                   armhf        simple interprocess messaging system (library)
...
ii  libdevmapper1.02.1:armhf                       2:1.02.90-2.2                     armhf        Linux Kernel Device Mapper userspace library
ii  libdns-export100                               1:9.9.5.dfsg-9+deb8u4             armhf        Exported DNS Shared Library
ii  libdns100                                      1:9.9.5.dfsg-9+deb8u4             armhf        DNS Shared Library used by BIND
...
ii  libev3devkit-0.3-0                             0.3.2                             armhf        Programming toolkit for ev3dev
ii  libevent-2.0-5:armhf                           2.0.21-stable-2                   armhf        Asynchronous event notification library
...
ii  libfuse2:armhf                                 2.9.3-15+deb8u1                   armhf        Filesystem in Userspace (library)
...
ii  libgnutls-deb0-28:armhf                        3.3.8-6+deb8u3                    armhf        GNU TLS library - main runtime library
...
ii  libgssapi-krb5-2:armhf                         1.12.1+dfsg-19+deb8u1             armhf        MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
ii  libgssapi3-heimdal:armhf                       1.6~rc2+dfsg-9                    armhf        Heimdal Kerberos - GSSAPI support library
ii  libgudev-1.0-0:armhf                           215-17+deb8u3                     armhf        GObject-based wrapper library for libudev
...
ii  libheimntlm0-heimdal:armhf                     1.6~rc2+dfsg-9                    armhf        Heimdal Kerberos - NTLM support library
...
ii  libidn11:armhf                                 1.29-1+b2                         armhf        GNU Libidn library, implementation of IETF IDN specifications
ii  libirs-export91                                1:9.9.5.dfsg-9+deb8u4             armhf        Exported IRS Shared Library
ii  libisc-export95                                1:9.9.5.dfsg-9+deb8u4             armhf        Exported ISC Shared Library
ii  libisc95                                       1:9.9.5.dfsg-9+deb8u4             armhf        ISC Shared Library used by BIND
ii  libisccc90                                     1:9.9.5.dfsg-9+deb8u4             armhf        Command Channel Library used by BIND
ii  libisccfg-export90                             1:9.9.5.dfsg-9+deb8u4             armhf        Exported ISC CFG Shared Library
ii  libisccfg90                                    1:9.9.5.dfsg-9+deb8u4             armhf        Config File Handling Library used by BIND
...
ii  libk5crypto3:armhf                             1.12.1+dfsg-19+deb8u1             armhf        MIT Kerberos runtime libraries - Crypto Library
ii  libkdc2-heimdal:armhf                          1.6~rc2+dfsg-9                    armhf        Heimdal Kerberos - KDC support library
...
ii  libkrb5-3:armhf                                1.12.1+dfsg-19+deb8u1             armhf        MIT Kerberos runtime libraries
ii  libkrb5support0:armhf                          1.12.1+dfsg-19+deb8u1             armhf        MIT Kerberos runtime libraries - Support library
...
ii  libldb1:armhf                                  2:1.1.17-2+deb8u1                 armhf        LDAP-like embedded database - shared library
...
ii  liblwres90                                     1:9.9.5.dfsg-9+deb8u4             armhf        Lightweight Resolver Library used by BIND
...
ii  libpam-modules:armhf                           1.1.8-3.1+deb8u1                  armhf        Pluggable Authentication Modules for PAM
ii  libpam-modules-bin                             1.1.8-3.1+deb8u1                  armhf        Pluggable Authentication Modules for PAM - helper binaries
ii  libpam-runtime                                 1.1.8-3.1+deb8u1                  all          Runtime support for the PAM library
ii  libpam-systemd:armhf                           215-17+deb8u3                     armhf        system and service manager - PAM module
ii  libpam0g:armhf                                 1.1.8-3.1+deb8u1                  armhf        Pluggable Authentication Modules library
ii  libparted2:armhf                               3.2-7                             armhf        disk partition manipulator - shared library
ii  libpcre3:armhf                                 2:8.35-3.3+deb8u2                 armhf        Perl 5 Compatible Regular Expression Library - runtime files
...
ii  libsmbclient:armhf                             2:4.1.17+dfsg-2+deb8u1            armhf        shared library for communication with SMB/CIFS servers
ii  libsndfile1:armhf                              1.0.25-9.1                        armhf        Library for reading/writing audio files
...
ii  libssl-dev:armhf                               1.0.1k-3+deb8u2                   armhf        Secure Sockets Layer toolkit - development files
...
ii  libsystemd0:armhf                              215-17+deb8u3                     armhf        systemd utility library
...
ii  libtevent0:armhf                               0.9.21-1                          armhf        talloc-based event loop library - shared library
...
ii  libudev1:armhf                                 215-17+deb8u3                     armhf        libudev shared library
...
ii  libwbclient0:armhf                             2:4.1.17+dfsg-2+deb8u1            armhf        Samba winbind client library
...
ii  libxml2:armhf                                  2.9.1+dfsg1-5+deb8u1              armhf        GNOME XML library
...
ii  linux-image-4.1.13-ti-r38-10-rc1-ev3dev-bb.org 1~1                               armhf        Linux kernel binary image for version 4.1.13-ti-r38-10-rc1-ev3dev-bb.org
ii  linux-image-ev3dev-bb.org                      1~1                               armhf        Linux kernel for ev3dev (meta-package)
...
ii  multiarch-support                              2.19-18+deb8u2                    armhf        Transitional package to ensure multiarch compatibility
...
ii  openssh-client                                 1:6.7p1-5+deb8u1                  armhf        secure shell (SSH) client, for secure access to remote machines
ii  openssh-server                                 1:6.7p1-5+deb8u1                  armhf        secure shell (SSH) server, for secure access from remote machines
ii  openssh-sftp-server                            1:6.7p1-5+deb8u1                  armhf        secure shell (SSH) sftp server module, for SFTP access from remote machines
...
ii  perl                                           5.20.2-3+deb8u3                   armhf        Larry Wall's Practical Extraction and Report Language
ii  perl-base                                      5.20.2-3+deb8u3                   armhf        minimal Perl system
...
ii  python-crypto                                  2.6.1-5+b2                        armhf        cryptographic algorithms and protocols for Python
ii  python-dbus                                    1.2.0-2+b3                        armhf        simple interprocess messaging system (Python interface)
...
ii  python-ldb                                     2:1.1.17-2+deb8u1                 armhf        Python bindings for LDB
...
ii  python-pil:armhf                               2.6.1-2                           armhf        Python Imaging Library (Pillow fork)
...
ii  python-samba                                   2:4.1.17+dfsg-2+deb8u1            armhf        Python bindings for Samba
...
ii  python-tdb                                     1.3.1-1                           armhf        Python bindings for TDB
...
ii  samba                                          2:4.1.17+dfsg-2+deb8u1            armhf        SMB/CIFS file, print, and login server for Unix
ii  samba-common                                   2:4.1.17+dfsg-2+deb8u1            all          common files used by both the Samba server and client
ii  samba-common-bin                               2:4.1.17+dfsg-2+deb8u1            armhf        Samba common files used by both the server and the client
ii  samba-dsdb-modules                             2:4.1.17+dfsg-2+deb8u1            armhf        Samba Directory Services Database
ii  samba-libs:armhf                               2:4.1.17+dfsg-2+deb8u1            armhf        Samba core libraries
...
ii  ssh                                            1:6.7p1-5+deb8u1                  all          secure shell client and server (metapackage)
...
ii  systemd                                        215-17+deb8u3                     armhf        system and service manager
ii  systemd-sysv                                   215-17+deb8u3                     armhf        system and service manager - SysV links
...
ii  tdb-tools                                      1.3.1-1                           armhf        Trivial Database - bundled binaries
...
ii  udev                                           215-17+deb8u3                     armhf        /dev/ and hotplug management daemon
