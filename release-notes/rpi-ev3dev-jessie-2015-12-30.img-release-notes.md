Release notes for rpi-ev3dev-jessie-2015-12-30.img
==============================================
...
* ev3dev kernel 4.1.15-9-ev3dev-rpi
...
ii  libgssapi3-heimdal:armhf        1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - GSSAPI support library
...
ii  libheimntlm0-heimdal:armhf      1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - NTLM support library
...
ii  libidn11:armhf                  1.29-1                            armhf        GNU Libidn library, implementation of IETF IDN specifications
...
ii  libkdc2-heimdal:armhf           1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - KDC support library
...
ii  libpng12-0:armhf                1.2.50-2+deb8u1                   armhf        PNG library - runtime
...
ii  linux-image-4.1.15-9-ev3dev-rpi 1                                 armhf        Linux kernel binary image for version 4.1.15-9-ev3dev-rpi
ii  linux-image-ev3dev-rpi          5                                 armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
...
iF  makedev                         2.3.1-93                          all          creates device files in /dev
...
iU  mountall                        2.54                              armhf        filesystem mounting tool
