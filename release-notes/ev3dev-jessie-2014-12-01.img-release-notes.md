Release notes for ev3dev-jessie-2014-12-01.img
==============================================

Changes from previous version
-----------------------------
* Added sshfs and libnss-myhostname packages
* Updated versions of other packages
...
ii  apt                               1.0.9.3                        armel        commandline package manager
...
ii  brickman                          0.2.0                          armel        ev3dev Brick Manager
ii  bsdmainutils                      9.0.6                          armel        collection of more utilities from FreeBSD
ii  bsdutils                          1:2.25.2-3                     armel        basic utilities from 4.4BSD-Lite
ii  ca-certificates                   20141019                       all          Common CA certificates
ii  connman                           1.26-0ev3dev6                  armel        Intel Connection Manager daemon
ii  console-setup                     1.114                          all          console font and keymap setup program
ii  console-setup-linux               1.114                          all          Linux specific part of console-setup
ii  conspy                            1.10-1                         armel        Remote control of Linux virtual consoles
ii  coreutils                         8.23-3                         armel        GNU core utilities
ii  cpio                              2.11+dfsg-2+b1                 armel        GNU cpio -- a program to manage archives of files
ii  dash                              0.5.7-4+b1                     armel        POSIX-compliant shell
ii  dbus                              1.8.12-1                       armel        simple interprocess messaging system (daemon and utilities)
...
ii  dpkg                              1.17.21                        armel        Debian package management system
...
ii  flash-kernel                      3.28                           armel        utility to make certain embedded devices bootable
...
ii  gcc-4.8-base:armel                4.8.3-13                       armel        GCC, the GNU Compiler Collection (base package)
ii  gcc-4.9-base:armel                4.9.1-19                       armel        GCC, the GNU Compiler Collection (base package)
...
ii  grep                              2.20-4                         armel        GNU grep, egrep and fgrep
...
ii  initscripts                       2.88dsf-58                     armel        scripts for initializing and shutting down the system
...
ii  isc-dhcp-client                   4.3.1-5                        armel        DHCP client for automatically obtaining an IP address
ii  isc-dhcp-common                   4.3.1-5                        armel        common files used by all of the isc-dhcp packages
ii  kbd                               1.15.5-2                       armel        Linux console font and keytable utilities
ii  keyboard-configuration            1.114                          all          system-wide keyboard preferences
...
ii  libapt-pkg4.12:armel              1.0.9.3                        armel        package management runtime library
ii  libasn1-8-heimdal:armel           1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - ASN.1 library
...
ii  libavahi-client3:armel            0.6.31-4+b1                    armel        Avahi client library
ii  libavahi-common-data:armel        0.6.31-4+b1                    armel        Avahi common data files
ii  libavahi-common3:armel            0.6.31-4+b1                    armel        Avahi common library
ii  libblkid1:armel                   2.25.2-3                       armel        block device id library
ii  libbsd0:armel                     0.7.0-2                        armel        utility functions from BSD systems - shared library
ii  libbz2-1.0:armel                  1.0.6-7+b1                     armel        high-quality block-sorting file compressor library - runtime
...
ii  libc-bin                          2.19-13                        armel        GNU C Library: Binaries
ii  libc-dev-bin                      2.19-13                        armel        GNU C Library: Development binaries
ii  libc6:armel                       2.19-13                        armel        GNU C Library: Shared libraries
ii  libc6-dev:armel                   2.19-13                        armel        GNU C Library: Development Libraries and Header Files
...
ii  libcryptsetup4:armel              2:1.6.6-3                      armel        disk encryption support - shared library
ii  libcups2:armel                    1.7.5-7                        armel        Common UNIX Printing System(tm) - Core library
ii  libdb5.3:armel                    5.3.28-6                       armel        Berkeley v5.3 Database Libraries [runtime]
ii  libdbus-1-3:armel                 1.8.12-1                       armel        simple interprocess messaging system (library)
...
ii  libdns-export100                  1:9.9.5.dfsg-5                 armel        Exported DNS Shared Library
ii  libdrm2:armel                     2.4.58-2                       armel        Userspace interface to kernel DRM services -- runtime
...
ii  libgcc1:armel                     1:4.9.1-19                     armel        GCC support library
ii  libgcrypt20:armel                 1.6.2-4                        armel        LGPL Crypto library - runtime library
...
ii  libglib2.0-0:armel                2.42.0-2                       armel        GLib library of C routines
...
ii  libgnutls-deb0-28:armel           3.3.8-5                        armel        GNU TLS library - main runtime library
ii  libgnutls-openssl27:armel         3.3.8-5                        armel        GNU TLS library - OpenSSL wrapper
ii  libgpg-error0:armel               1.17-2                         armel        library for common error values and messages in GnuPG components
...
ii  libgssapi-krb5-2:armel            1.12.1+dfsg-15                 armel        MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
ii  libgssapi3-heimdal:armel          1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - GSSAPI support library
ii  libgudev-1.0-0:armel              215-6                          armel        GObject-based wrapper library for libudev
ii  libhcrypto4-heimdal:armel         1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - crypto library
ii  libheimbase1-heimdal:armel        1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - Base library
ii  libheimntlm0-heimdal:armel        1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - NTLM support library
ii  libhogweed2:armel                 2.7.1-3                        armel        low level cryptographic library (public-key cryptos)
ii  libhx509-5-heimdal:armel          1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - X509 support library
ii  libicu52:armel                    52.1-6                         armel        International Components for Unicode
ii  libidn11:armel                    1.29-1+b1                      armel        GNU Libidn library, implementation of IETF IDN specifications
ii  libirs-export91                   1:9.9.5.dfsg-5                 armel        Exported IRS Shared Library
ii  libisc-export95                   1:9.9.5.dfsg-5                 armel        Exported ISC Shared Library
ii  libisccfg-export90                1:9.9.5.dfsg-5                 armel        Exported ISC CFG Shared Library
ii  libjbig0:armel                    2.1-3.1                        armel        JBIGkit libraries
ii  libjpeg62-turbo:armel             1:1.3.1-10                     armel        libjpeg-turbo JPEG runtime library
...
ii  libk5crypto3:armel                1.12.1+dfsg-15                 armel        MIT Kerberos runtime libraries - Crypto Library
...
ii  libkrb5-26-heimdal:armel          1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - libraries
ii  libkrb5-3:armel                   1.12.1+dfsg-15                 armel        MIT Kerberos runtime libraries
ii  libkrb5support0:armel             1.12.1+dfsg-15                 armel        MIT Kerberos runtime libraries - Support library
ii  libldap-2.4-2:armel               2.4.40-3                       armel        OpenLDAP libraries
...
ii  liblzma5:armel                    5.1.1alpha+20120614-2+b2       armel        XZ-format compression library
ii  libmount1:armel                   2.25.2-3                       armel        device mounting library
ii  libmpdec2:armel                   2.4.1-1                        armel        library for decimal floating point arithmetic (runtime library)
ii  libmpfr4:armel                    3.1.2-1+b1                     armel        multiple precision floating-point computation
...
ii  libpcre3:armel                    1:8.35-3.1                     armel        Perl 5 Compatible Regular Expression Library - runtime files
...
ii  libpython-stdlib:armel            2.7.8-2                        armel        interactive high-level object-oriented language (default python version)
ii  libpython2.7:armel                2.7.8-11                       armel        Shared Python runtime library (version 2.7)
ii  libpython2.7-minimal:armel        2.7.8-11                       armel        Minimal subset of the Python language (version 2.7)
ii  libpython2.7-stdlib:armel         2.7.8-11                       armel        Interactive high-level object-oriented language (standard library, version 2.7)
ii  libpython3-stdlib:armel           3.4.2-1                        armel        interactive high-level object-oriented language (default python3 version)
...
ii  libreadline6:armel                6.3-8+b1                       armel        GNU readline and history libraries, run-time libraries
ii  libroken18-heimdal:armel          1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - roken support library
ii  libruby2.1:armel                  2.1.4-1                        armel        Libraries necessary to run Ruby 2.1
ii  libsamplerate0:armel              0.1.8-8                        armel        Audio sample rate conversion library
ii  libsasl2-2:armel                  2.1.26.dfsg1-12                armel        Cyrus SASL - authentication abstraction library
ii  libsasl2-modules-db:armel         2.1.26.dfsg1-12                armel        Cyrus SASL - pluggable authentication modules (DB)
...
ii  libsmartcols1:armel               2.25.2-3                       armel        smart column output alignment library
ii  libsmbclient:armel                2:4.1.13+dfsg-2                armel        shared library for communication with SMB/CIFS servers
...
ii  libssl-dev:armel                  1.0.1j-1                       armel        Secure Sockets Layer toolkit - development files
ii  libssl1.0.0:armel                 1.0.1j-1                       armel        Secure Sockets Layer toolkit - shared libraries
ii  libstdc++6:armel                  4.9.1-19                       armel        GNU Standard C++ Library v3
ii  libsystemd0:armel                 215-6                          armel        systemd utility library
ii  libtalloc2:armel                  2.1.1-2                        armel        hierarchical pool based memory allocator
ii  libtasn1-6:armel                  4.2-2                          armel        Manage ASN.1 structures (runtime)
...
ii  libtiff5:armel                    4.0.3-10+b3                    armel        Tag Image File Format (TIFF) library
...
ii  libudev1:armel                    215-6                          armel        libudev shared library
...
ii  libuuid1:armel                    2.25.2-3                       armel        Universally Unique ID library
...
ii  libwbclient0:armel                2:4.1.13+dfsg-2                armel        Samba winbind client library
ii  libwind0-heimdal:armel            1.6~rc2+dfsg-8+b1              armel        Heimdal Kerberos - stringprep implementation
...
ii  linux-image-3.16.1-7-ev3dev       2                              armel        Linux kernel binary image for version 3.16.1-7-ev3dev
ii  linux-image-ev3dev                13                             armel        Linux kernel for ev3dev (meta-package)
ii  linux-libc-dev:armel              3.16.7-2                       armel        Linux support headers for userspace development
...
ii  lua5.1                            5.1.5-7.1                      armel        Simple, extensible, embeddable programming language
...
ii  mount                             2.25.2-3                       armel        Tools for mounting and manipulating filesystems
ii  multiarch-support                 2.19-13                        armel        Transitional package to ensure multiarch compatibility
...
ii  ntp                               1:4.2.6.p5+dfsg-3.1+b1         armel        Network Time Protocol daemon and utility programs
ii  openssh-client                    1:6.7p1-3                      armel        secure shell (SSH) client, for secure access to remote machines
ii  openssh-server                    1:6.7p1-3                      armel        secure shell (SSH) server, for secure access from remote machines
ii  openssh-sftp-server               1:6.7p1-3                      armel        secure shell (SSH) sftp server module, for SFTP access from remote machines
ii  openssl                           1.0.1j-1                       armel        Secure Sockets Layer toolkit - cryptographic utility
ii  parted                            3.2-6                          armel        disk partition manipulator
ii  passwd                            1:4.2-3                        armel        change and administer password and group data
ii  perl                              5.20.1-3                       armel        Larry Wall's Practical Extraction and Report Language
ii  perl-base                         5.20.1-3                       armel        minimal Perl system
ii  perl-modules                      5.20.1-3                       all          Core Perl modules
ii  plymouth                          0.9.0-8ev3dev1                 armel        Graphical Boot Animation and Logger
ii  procps                            2:3.3.9-8                      armel        /proc file system utilities
ii  psmisc                            22.21-2                        armel        utilities that use the proc file system
ii  python                            2.7.8-2                        armel        interactive high-level object-oriented language (default version)
...
ii  python-minimal                    2.7.8-2                        armel        minimal subset of the Python language (default version)
...
ii  python2.7                         2.7.8-11                       armel        Interactive high-level object-oriented language (version 2.7)
ii  python2.7-minimal                 2.7.8-11                       armel        Minimal subset of the Python language (version 2.7)
ii  python3                           3.4.2-1                        armel        interactive high-level object-oriented language (default python3 version)
ii  python3-minimal                   3.4.2-1                        armel        minimal subset of the Python language (default python3 version)
...
ii  rtl8188eu-modules-3.16.1-7-ev3dev 3+2                            armel        rtl8188eu modules for Linux (kernel 3.16.1-7-ev3dev).
ii  rtl8192cu-modules-3.16.1-7-ev3dev 4.0.2-9000.20131029-0ev3dev2+2 armel        rtl8192cu series modules for Linux (kernel 3.16.1-7-ev3dev).
ii  rtl8192cu-modules-common          4.0.2-9000.20131029-0ev3dev2+2 all          rtl8192cu series modules for Linux.
ii  ruby                              1:2.1.0.4                      all          Interpreter of object-oriented scripting language Ruby (default version)
ii  ruby2.1                           2.1.4-1                        armel        Interpreter of object-oriented scripting language Ruby
ii  rubygems-integration              1.8                            all          integration of Debian Ruby packages with Rubygems
ii  samba-libs:armel                  2:4.1.13+dfsg-2                armel        Samba core libraries
...
ii  ssh                               1:6.7p1-3                      all          secure shell client and server (metapackage)
...
ii  systemd                           215-6                          armel        system and service manager
ii  systemd-sysv                      215-6                          armel        system and service manager - SysV links
ii  sysv-rc                           2.88dsf-58                     all          System-V-like runlevel change mechanism
ii  sysvinit-utils                    2.88dsf-58                     armel        System-V-like utilities
...
ii  u-boot-tools                      2014.10+dfsg1-2                armel        companion tools for Das U-Boot bootloader
ii  ucf                               3.0030                         all          Update Configuration File(s): preserve user changes to config files
ii  udev                              215-6                          armel        /dev/ and hotplug management daemon
ii  usbutils                          1:007-2                        armel        Linux USB utilities
ii  util-linux                        2.25.2-3                       armel        Miscellaneous system utilities
ii  vim                               2:7.4.488-2                    armel        Vi IMproved - enhanced vi editor
ii  vim-common                        2:7.4.488-2                    armel        Vi IMproved - Common files
