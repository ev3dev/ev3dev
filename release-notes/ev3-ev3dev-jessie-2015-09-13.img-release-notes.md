Release notes for ev3-ev3dev-jessie-2015-09-13.img
==============================================

Changes from previous version
-----------------------------

* Updated packages from Debian 8.2 point release.
* ev3dev kernel 3.16.7-ckt16-7-ev3dev-ev3
* Updated brickman, connman and grx packages
* Added ev3devkit, i2c-tools and python-smbus packages
...
ii  brickman                                    0.6.2                    armel        ev3dev Brick Manager
...
ii  connman                                     1.30-0ev3dev1            armel        Intel Connection Manager daemon
...
ii  ev3-systemd                                 3                        armel        Systemd unit files and udev rules for LEGO MINDSTORMS EV3.
...
ii  ev3devkit-data                              0.2.1                    all          Programming toolkit for ev3dev
...
ii  libev3devkit-0.1-0                          0.2.1                    armel        Programming toolkit for ev3dev
...
ii  libgee-0.8-2:armel                          0.16.1-1+deb8u1          armel        GObject based collection and utility library
...
ii  linux-image-3.16.7-ckt16-7-ev3dev-ev3       1                        armel        Linux kernel binary image for version 3.16.7-ckt16-7-ev3dev-ev3
ii  linux-image-ev3dev-ev3                      22                       armel        Linux kernel for ev3dev (meta-package)
...
ii  rtl8188eu-modules-3.16.7-ckt16-7-ev3dev-ev3 5+1                      armel        rtl8188eu modules for Linux (kernel 3.16.7-ckt16-7-ev3dev-ev3).
