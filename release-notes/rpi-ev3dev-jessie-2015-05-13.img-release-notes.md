Release notes for rpi-ev3dev-jessie-2015-05-13.img
==============================================

Changes from previous version
-----------------------------

* Fixed ev3dev.org apt URL in `/etc/apt/sources.list`.
* Support for Dexter Industries BrickPi
* Updated config.txt for BrickPi stuff.
...
ii  bind9-host                       1:9.9.5.dfsg-9                    armhf        Version of 'host' bundled with BIND 9.X
ii  binutils                         2.25-5                            armhf        GNU assembler, linker and binary utilities
ii  brickpi-systemd                  1                                 all          Udev rule and systemd service for BrickPi.
ii  bsdutils                         1:2.25.2-6                        armhf        basic utilities from 4.4BSD-Lite
ii  ca-certificates                  20141019                          all          Common CA certificates
ii  connman                          1.29-0ev3dev2                     armhf        Intel Connection Manager daemon
...
ii  dbus                             1.8.16-1                          armhf        simple interprocess messaging system (daemon and utilities)
...
ii  libapt-pkg4.12:armhf             1.0.9.8                           armhf        package management runtime library
...
ii  libbind9-90                      1:9.9.5.dfsg-9                    armhf        BIND9 Shared Library used by BIND
...
ii  libcups2:armhf                   1.7.5-11                          armhf        Common UNIX Printing System(tm) - Core library
...
ii  libdbus-1-3:armhf                1.8.16-1                          armhf        simple interprocess messaging system (library)
...
ii  libdns100                        1:9.9.5.dfsg-9                    armhf        DNS Shared Library used by BIND
...
ii  libexpat1:armhf                  2.1.0-6                           armhf        XML parsing C library - runtime library
...
ii  libgnutls-deb0-28:armhf          3.3.8-6                           armhf        GNU TLS library - main runtime library
ii  libgnutls-openssl27:armhf        3.3.8-6                           armhf        GNU TLS library - OpenSSL wrapper
...
ii  libisc95                         1:9.9.5.dfsg-9                    armhf        ISC Shared Library used by BIND
ii  libisccc90                       1:9.9.5.dfsg-9                    armhf        Command Channel Library used by BIND
ii  libisccfg-export90               1:9.9.5.dfsg-9                    armhf        Exported ISC CFG Shared Library
ii  libisccfg90                      1:9.9.5.dfsg-9                    armhf        Config File Handling Library used by BIND
...
ii  liblwres90                       1:9.9.5.dfsg-9                    armhf        Lightweight Resolver Library used by BIND
...
ii  libnss-winbind:armhf             2:4.1.17+dfsg-2                   armhf        Samba nameservice integration plugins
...
ii  libpam-systemd:armhf             215-17                            armhf        system and service manager - PAM module
...
ii  libraspberrypi-bin               1.20150513-1ev3dev1               armhf        Miscellaneous Raspberry Pi utilities
ii  libraspberrypi0                  1.20150513-1ev3dev1               armhf        EGL/GLES/OpenVG/etc. libraries for the Raspberry Pi's VideoCore IV
...
ii  libruby2.1:armhf                 2.1.5-2+deb8u1                    armhf        Libraries necessary to run Ruby 2.1
...
ii  libssl-dev:armhf                 1.0.1k-3                          armhf        Secure Sockets Layer toolkit - development files
ii  libssl1.0.0:armhf                1.0.1k-3                          armhf        Secure Sockets Layer toolkit - shared libraries
ii  libstdc++6:armhf                 4.9.2-10                          armhf        GNU Standard C++ Library v3
ii  libsystemd0:armhf                215-17                            armhf        systemd utility library
...
ii  libudev1:armhf                   215-17                            armhf        libudev shared library
...
ii  libv8-3.14-dev                   3.14.5.8-8+rpi1                   armhf        V8 JavaScript engine - development files for 3.14 branch
ii  libv8-3.14.5                     3.14.5.8-8+rpi1                   armhf        V8 JavaScript engine - runtime library
...
ii  linux-image-3.18.13-5-ev3dev-rpi 1                                 armhf        Linux kernel binary image for version 3.18.13-5-ev3dev-rpi
ii  linux-image-ev3dev-rpi           2                                 armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
ii  linux-libc-dev:armhf             3.16.7-ckt4-1+rpi1                armhf        Linux support headers for userspace development
...
ii  multiarch-support                2.19-18                           armhf        Transitional package to ensure multiarch compatibility
...
ii  openssl                          1.0.1k-3                          armhf        Secure Sockets Layer toolkit - cryptographic utility
ii  parted                           3.2-7                             armhf        disk partition manipulator
ii  passwd                           1:4.2-3                           armhf        change and administer password and group data
ii  perl                             5.20.2-3                          armhf        Larry Wall's Practical Extraction and Report Language
ii  perl-base                        5.20.2-3                          armhf        minimal Perl system
...
ii  raspberrypi-bootloader           1.20150513-1ev3dev1               armhf        Raspberry Pi bootloader
...
ii  rpi-mkimage                      20150402                          all          Tool to add "trailer" to device-tree capable Raspberry Pi kernels.
ii  ruby                             1:2.1.5                           all          Interpreter of object-oriented scripting language Ruby (default version)
ii  ruby2.1                          2.1.5-2+deb8u1                    armhf        Interpreter of object-oriented scripting language Ruby
...
ii  systemd                          215-17                            armhf        system and service manager
ii  systemd-sysv                     215-17                            armhf        system and service manager - SysV links
...
ii  udev                             215-17                            armhf        /dev/ and hotplug management daemon
...
ii  winbind                          2:4.1.17+dfsg-2                   armhf        service to resolve user and group information from Windows NT servers
