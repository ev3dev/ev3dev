Release notes for ev3dev-jessie-rpi-generic-2017-09-14
======================================================
...
ii  beep                             1.3-3                             armhf        advanced pc-speaker beeper
...
ii  libasn1-8-heimdal:armhf          1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - ASN.1 library
...
ii  libdrm2:armhf                    2.4.58-2                          armhf        Userspace interface to kernel DRM services -- runtime
...
ii  libhdb9-heimdal:armhf            1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - kadmin server library
ii  libheimbase1-heimdal:armhf       1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - Base library
ii  libhogweed2:armhf                2.7.1-5+deb8u2                    armhf        low level cryptographic library (public-key cryptos)
ii  libhx509-5-heimdal:armhf         1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - X509 support library
ii  libice6:armhf                    2:1.0.9-1                         armhf        X11 Inter-Client Exchange library
...
ii  libkrb5-26-heimdal:armhf         1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - libraries
...
ii  libpam-modules:armhf             1.1.8-3.1+deb8u2                  armhf        Pluggable Authentication Modules for PAM
ii  libpam-modules-bin               1.1.8-3.1+deb8u2                  armhf        Pluggable Authentication Modules for PAM - helper binaries
...
ii  libpam0g:armhf                   1.1.8-3.1+deb8u2                  armhf        Pluggable Authentication Modules library
...
ii  libroken18-heimdal:armhf         1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - roken support library
...
ii  libsigsegv2:armhf                2.10-4                            armhf        Library for handling page faults in a portable way
ii  libslang2:armhf                  2.3.0-2                           armhf        S-Lang programming library - runtime version
ii  libsm6:armhf                     2:1.2.2-1                         armhf        X11 Session Management library
...
ii  libv8-3.14-dev                   3.14.5.8-8.1+rpi1                 armhf        V8 JavaScript engine - development files for 3.14 branch
...
ii  libwebp5:armhf                   0.4.1-1.2                         armhf        Lossy compression of digital photographic images.
ii  libwebpdemux1:armhf              0.4.1-1.2                         armhf        Lossy compression of digital photographic images.
ii  libwebpmux1:armhf                0.4.1-1.2                         armhf        Lossy compression of digital photographic images.
ii  libwind0-heimdal:armhf           1.6~rc2+dfsg-9+rpi1               armhf        Heimdal Kerberos - stringprep implementation
...
ii  libxi6:armhf                     2:1.7.4-1                         armhf        X11 Input extension library
...
ii  libxtst6:armhf                   2:1.2.2-1                         armhf        X11 Testing -- Record extension library
...
ii  linux-image-4.4.78-21-ev3dev-rpi 1                                 armhf        Linux kernel binary image for version 4.4.78-21-ev3dev-rpi
ii  linux-image-ev3dev-rpi           16+jessie4                        armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
...
ii  openrobertalab                   1.3.2+1.0.0                       all          lab.open-roberta.org connector for ev3dev.org
...
ii  python-bluez                     0.22-1ev3dev2                     armhf        Python wrappers around BlueZ for rapid bluetooth development
...
ii  python-ev3dev                    0.6.0                             all          Python language bindings for ev3dev
...
ii  python-pil:armhf                 2.6.1-2+deb8u3                    armhf        Python Imaging Library (Pillow fork)
