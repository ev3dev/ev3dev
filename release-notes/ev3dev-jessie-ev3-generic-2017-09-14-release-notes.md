Release notes for ev3dev-jessie-ev3-generic-2017-09-14
========================================

Changes from previous version
-----------------------------
* Debian 8.9
* More reliable startup of Bluetooth
* Fix crash when using color screen
...
ii  apt                                    1.0.9.8.4                        armel        commandline package manager
...
ii  bash                                   4.3-11+deb8u1                    armel        GNU Bourne Again SHell
ii  beep                                   1.3-3+b1                         armel        advanced pc-speaker beeper
ii  bind9-host                             1:9.9.5.dfsg-9+deb8u13           armel        Version of 'host' bundled with BIND 9.X
ii  bluez                                  5.23-2ev3dev2                    armel        Bluetooth tools and daemons
ii  brickman                               0.8.1                            armel        ev3dev Brick Manager
...
ii  dbus                                   1.8.22-0+deb8u1                  armel        simple interprocess messaging system (daemon and utilities)
...
ii  e2fslibs:armel                         1.42.12-2+b1                     armel        ext2/ext3/ext4 file system libraries
ii  e2fsprogs                              1.42.12-2+b1                     armel        ext2/ext3/ext4 file system utilities
...
ii  ev3-systemd                            5.3.0jessie1                     armel        Systemd unit files and udev rules for LEGO MINDSTORMS EV3.
...
ii  flash-kernel                           3.35ev3dev15                     armel        utility to make certain embedded devices bootable
...
ii  gir1.2-ev3devkit-0.4                   0.4.3                            armel        Programming toolkit for ev3dev
ii  gir1.2-glib-2.0:armel                  1.42.0-2.2                       armel        Introspection data for GLib, GObject, Gio and GModule
ii  gir1.2-gudev-1.0                       215-17+deb8u7                    armel        libgudev-1.0 introspection data
ii  git                                    1:2.1.4-2.1+deb8u4               armel        fast, scalable, distributed revision control system
...
ii  libapt-pkg4.12:armel                   1.0.9.8.4                        armel        package management runtime library
ii  libasn1-8-heimdal:armel                1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - ASN.1 library
...
ii  libbind9-90                            1:9.9.5.dfsg-9+deb8u13           armel        BIND9 Shared Library used by BIND
...
ii  libboost-python1.55.0                  1.55.0+dfsg-3                    armel        Boost.Python Library
...
ii  libc-ares-dev:armel                    1.10.0-2+deb8u2                  armel        asynchronous name resolver - development files
ii  libc-ares2:armel                       1.10.0-2+deb8u2                  armel        asynchronous name resolver
ii  libc-bin                               2.19-18+deb8u10                  armel        GNU C Library: Binaries
ii  libc-dev-bin                           2.19-18+deb8u10                  armel        GNU C Library: Development binaries
ii  libc6:armel                            2.19-18+deb8u10                  armel        GNU C Library: Shared libraries
ii  libc6-dev:armel                        2.19-18+deb8u10                  armel        GNU C Library: Development Libraries and Header Files
...
ii  libcomerr2:armel                       1.42.12-2+b1                     armel        common error description library
...
ii  libdbus-1-3:armel                      1.8.22-0+deb8u1                  armel        simple interprocess messaging system (library)
...
ii  libdns-export100                       1:9.9.5.dfsg-9+deb8u13           armel        Exported DNS Shared Library
ii  libdns100                              1:9.9.5.dfsg-9+deb8u13           armel        DNS Shared Library used by BIND
...
ii  libev3devkit-0.4-0                     0.4.3                            armel        Programming toolkit for ev3dev
ii  libevdev2                              1.3+dfsg-1                       armel        wrapper library for evdev devices
ii  libevent-2.0-5:armel                   2.0.21-stable-2+deb8u1           armel        Asynchronous event notification library
ii  libexpat1:armel                        2.1.0-6+deb8u4                   armel        XML parsing C library - runtime library
ii  libffi6:armel                          3.1-2+deb8u1                     armel        Foreign Function Interface library runtime
ii  libfile-copy-recursive-perl            0.38-1                           all          Perl extension for recursively copying files and directories
ii  libfreetype6:armel                     2.5.2-3+deb8u2                   armel        FreeType 2 font engine, shared library files
...
ii  libgcrypt20:armel                      1.6.3-2+deb8u4                   armel        LGPL Crypto library - runtime library
...
ii  libgnutls-deb0-28:armel                3.3.8-6+deb8u7                   armel        GNU TLS library - main runtime library
ii  libgnutls-openssl27:armel              3.3.8-6+deb8u7                   armel        GNU TLS library - OpenSSL wrapper
...
ii  libgudev-1.0-0:armel                   215-17+deb8u7                    armel        GObject-based wrapper library for libudev
ii  libhcrypto4-heimdal:armel              1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - crypto library
ii  libhdb9-heimdal:armel                  1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - kadmin server library
ii  libheimbase1-heimdal:armel             1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - Base library
ii  libhogweed2:armel                      2.7.1-5+deb8u2                   armel        low level cryptographic library (public-key cryptos)
ii  libhx509-5-heimdal:armel               1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - X509 support library
ii  libicu52:armel                         52.1-8+deb8u5                    armel        International Components for Unicode
...
ii  libirs-export91                        1:9.9.5.dfsg-9+deb8u13           armel        Exported IRS Shared Library
ii  libisc-export95                        1:9.9.5.dfsg-9+deb8u13           armel        Exported ISC Shared Library
ii  libisc95                               1:9.9.5.dfsg-9+deb8u13           armel        ISC Shared Library used by BIND
ii  libisccc90                             1:9.9.5.dfsg-9+deb8u13           armel        Command Channel Library used by BIND
ii  libisccfg-export90                     1:9.9.5.dfsg-9+deb8u13           armel        Exported ISC CFG Shared Library
ii  libisccfg90                            1:9.9.5.dfsg-9+deb8u13           armel        Config File Handling Library used by BIND
ii  libjbig0:armel                         2.1-3.1                          armel        JBIGkit libraries
ii  libjim0.75:armel                       0.75-1                           armel        small-footprint implementation of Tcl - shared library
...
ii  libkrb5-26-heimdal:armel               1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - libraries
...
ii  liblcms2-2:armel                       2.6-3+deb8u1                     armel        Little CMS 2 color management library
ii  libldap-2.4-2:armel                    2.4.40+dfsg-1+deb8u3             armel        OpenLDAP libraries
...
ii  liblwres90                             1:9.9.5.dfsg-9+deb8u13           armel        Lightweight Resolver Library used by BIND
...
ii  libnettle4:armel                       2.7.1-5+deb8u2                   armel        low level cryptographic library (symmetric and one-way cryptos)
...
ii  libpam-modules:armel                   1.1.8-3.1+deb8u2+b1              armel        Pluggable Authentication Modules for PAM
ii  libpam-modules-bin                     1.1.8-3.1+deb8u2+b1              armel        Pluggable Authentication Modules for PAM - helper binaries
ii  libpam-runtime                         1.1.8-3.1+deb8u2                 all          Runtime support for the PAM library
ii  libpam-systemd:armel                   215-17+deb8u7                    armel        system and service manager - PAM module
ii  libpam0g:armel                         1.1.8-3.1+deb8u2+b1              armel        Pluggable Authentication Modules library
...
ii  libpcsclite1:armel                     1.8.13-1+deb8u1                  armel        Middleware to access a smart card using PC/SC (library)
ii  libpng12-0:armel                       1.2.50-2+deb8u3                  armel        PNG library - runtime
...
ii  libroken18-heimdal:armel               1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - roken support library
ii  librtmp1:armel                         2.4+20150115.gita107cef-1+deb8u1 armel        toolkit for RTMP streams (shared library)
...
ii  libsmbclient:armel                     2:4.2.14+dfsg-0+deb8u7           armel        shared library for communication with SMB/CIFS servers
...
ii  libss2:armel                           1.42.12-2+b1                     armel        command-line interface parsing library
ii  libssh2-1:armel                        1.4.3-4.1+deb8u1                 armel        SSH2 client-side library
ii  libssl-dev:armel                       1.0.1t-1+deb8u6                  armel        Secure Sockets Layer toolkit - development files
ii  libssl1.0.0:armel                      1.0.1t-1+deb8u6                  armel        Secure Sockets Layer toolkit - shared libraries
ii  libstdc++6:armel                       4.9.2-10                         armel        GNU Standard C++ Library v3
ii  libsystemd0:armel                      215-17+deb8u7                    armel        systemd utility library
ii  libtalloc2:armel                       2.1.2-0+deb8u1                   armel        hierarchical pool based memory allocator
ii  libtasn1-6:armel                       4.2-3+deb8u3                     armel        Manage ASN.1 structures (runtime)
...
ii  libtiff5:armel                         4.0.3-12.3+deb8u4                armel        Tag Image File Format (TIFF) library
ii  libtinfo5:armel                        5.9+20140913-1+b1                armel        shared low-level terminfo library for terminal handling
ii  libtirpc1:armel                        0.2.5-1+deb8u1                   armel        transport-independent RPC library
ii  libudev1:armel                         215-17+deb8u7                    armel        libudev shared library
...
ii  libwbclient0:armel                     2:4.2.14+dfsg-0+deb8u7           armel        Samba winbind client library
...
ii  libwind0-heimdal:armel                 1.6~rc2+dfsg-9+deb8u1            armel        Heimdal Kerberos - stringprep implementation
...
ii  libxml2:armel                          2.9.1+dfsg1-5+deb8u5             armel        GNOME XML library
...
ii  linux-image-4.4.87-22-ev3dev-ev3       1                                armel        Linux kernel binary image for version 4.4.87-22-ev3dev-ev3
ii  linux-image-ev3dev-ev3                 34+jessie5                       armel        Linux kernel for ev3dev (meta-package)
ii  linux-libc-dev:armel                   3.16.43-2+deb8u3                 armel        Linux support headers for userspace development
ii  locales                                2.19-18+deb8u10                  all          GNU C Library: National Language (locale) data [support]
ii  login                                  1:4.2-3+deb8u4                   armel        system login tools
...
ii  multiarch-support                      2.19-18+deb8u10                  armel        Transitional package to ensure multiarch compatibility
...
ii  openssl                                1.0.1t-1+deb8u6                  armel        Secure Sockets Layer toolkit - cryptographic utility
ii  parted                                 3.2-7                            armel        disk partition manipulator
ii  passwd                                 1:4.2-3+deb8u4                   armel        change and administer password and group data
ii  perl                                   5.20.2-3+deb8u8                  armel        Larry Wall's Practical Extraction and Report Language
ii  perl-base                              5.20.2-3+deb8u8                  armel        minimal Perl system
...
ii  python-crypto                          2.6.1-5+deb8u1                   armel        cryptographic algorithms and protocols for Python
...
ii  python-samba                           2:4.2.14+dfsg-0+deb8u7           armel        Python bindings for Samba
...
ii  python3-bluez                          0.22-1ev3dev2                    armel        Python wrappers around BlueZ for rapid bluetooth development
...
ii  python3-gattlib                        0.20150805-1ev3dev1              armel        Bluetooth LE GATT library (Python 3)
...
ii  rpcbind                                0.2.1-6+deb8u2                   armel        converts RPC program numbers into universal addresses
ii  rtl8188eu-modules-4.4.87-22-ev3dev-ev3 5+1                              armel        rtl8188eu modules for Linux (kernel 4.4.87-22-ev3dev-ev3).
...
ii  samba                                  2:4.2.14+dfsg-0+deb8u7           armel        SMB/CIFS file, print, and login server for Unix
ii  samba-common                           2:4.2.14+dfsg-0+deb8u7           all          common files used by both the Samba server and client
ii  samba-common-bin                       2:4.2.14+dfsg-0+deb8u7           armel        Samba common files used by both the server and the client
ii  samba-dsdb-modules                     2:4.2.14+dfsg-0+deb8u7           armel        Samba Directory Services Database
ii  samba-libs:armel                       2:4.2.14+dfsg-0+deb8u7           armel        Samba core libraries
ii  screen                                 4.2.1-3+deb8u1                   armel        terminal multiplexer with VT100/ANSI terminal emulation
ii  sed                                    4.2.2-4+deb8u1                   armel        The GNU sed stream editor
...
ii  sudo                                   1.8.10p3-1+deb8u4                armel        Provide limited super user privileges to specific users
ii  systemd                                215-17+deb8u7                    armel        system and service manager
ii  systemd-sysv                           215-17+deb8u7                    armel        system and service manager - SysV links
...
ii  udev                                   215-17+deb8u7                    armel        /dev/ and hotplug management daemon
ii  update-inetd                           4.43                             all          inetd configuration file updater
ii  usb-modeswitch                         2.2.0+repack0-2                  armel        mode switching tool for controlling "flip flop" USB devices
...
ii  vim                                    2:7.4.488-7+deb8u3               armel        Vi IMproved - enhanced vi editor
ii  vim-common                             2:7.4.488-7+deb8u3               armel        Vi IMproved - Common files
ii  vim-runtime                            2:7.4.488-7+deb8u3               all          Vi IMproved - Runtime files
ii  wget                                   1.16-1+deb8u2                    armel        retrieves files from the web
