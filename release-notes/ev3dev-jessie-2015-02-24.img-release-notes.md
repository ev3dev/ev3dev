Release notes for ev3dev-jessie-2015-02-24.img
==============================================

Changes from previous version
-----------------------------
* Added packages: ev3dev-connman-config, iptables, lua5.2 (removed lua5.1), nodejs-legacy, screen
* Updated versions of other packages

Known issues
------------
* `plymouth` is not working during boot/shutdown.
* Creating swap file sometimes fails during first boot. See [issue #267](https://github.com/ev3dev/ev3dev/issues/267).
...
ii  apt                                   1.0.9.6                                            armel        commandline package manager
...
ii  brickman                              0.5.0                                              armel        ev3dev Brick Manager
ii  bsdmainutils                          9.0.6                                              armel        collection of more utilities from FreeBSD
ii  bsdutils                              1:2.25.2-5                                         armel        basic utilities from 4.4BSD-Lite
ii  ca-certificates                       20141019                                           all          Common CA certificates
ii  connman                               1.28-0ev3dev1                                      armel        Intel Connection Manager daemon
ii  console-setup                         1.116                                              all          console font and keymap setup program
ii  console-setup-linux                   1.116                                              all          Linux specific part of console-setup
ii  conspy                                1.10-1                                             armel        Remote control of Linux virtual consoles
ii  coreutils                             8.23-3                                             armel        GNU core utilities
ii  cpio                                  2.11+dfsg-4                                        armel        GNU cpio -- a program to manage archives of files
ii  dash                                  0.5.7-4+b1                                         armel        POSIX-compliant shell
ii  dbus                                  1.8.12-3                                           armel        simple interprocess messaging system (daemon and utilities)
...
ii  dpkg                                  1.17.23                                            armel        Debian package management system
...
ii  ev3dev-base                           8.0                                                armel        Meta package that installs all of the required ev3dev packages.
ii  ev3dev-bluetooth                      8.0                                                armel        Firmware and scripts for EV3 bluetooth.
ii  ev3dev-connman-config                 1                                                  all          ev3dev-specific configuration files for connman
ii  ev3dev-console                        8.0                                                armel        Console related configuration files and console fonts.
ii  ev3dev-flash-kernel                   8.0                                                armel        Database entry and boot script for flash-kernel.
ii  ev3dev-gadget                         8.0                                                armel        systemd services for starting/stopping USB Ethernet gadget modules.
ii  ev3dev-i2c                            8.0                                                armel        Udev rules for I2C devices.
ii  ev3dev-leds                           8.0                                                armel        Initialization scripts for EV3 LEDs.
ii  ev3dev-ports                          8.0                                                armel        Scripts related to the EV3 input and output ports
ii  ev3dev-uart                           8.0                                                armel        Firmware and scripts for EV3 input port UARTs.
...
ii  flash-kernel                          3.30                                               armel        utility to make certain embedded devices bootable
...
ii  gnupg                                 1.4.18-6                                           armel        GNU privacy guard - a free PGP replacement
...
ii  gpgv                                  1.4.18-6                                           armel        GNU privacy guard - signature verification tool
...
ii  ifupdown                              0.7.52                                             armel        high level tools to configure network interfaces
...
ii  keyboard-configuration                1.116                                              all          system-wide keyboard preferences
...
ii  libapt-pkg4.12:armel                  1.0.9.6                                            armel        package management runtime library
...
ii  libavahi-client3:armel                0.6.31-4+b2                                        armel        Avahi client library
ii  libavahi-common-data:armel            0.6.31-4+b2                                        armel        Avahi common data files
ii  libavahi-common3:armel                0.6.31-4+b2                                        armel        Avahi common library
ii  libblkid1:armel                       2.25.2-5                                           armel        block device id library
ii  libbsd0:armel                         0.7.0-2                                            armel        utility functions from BSD systems - shared library
ii  libbz2-1.0:armel                      1.0.6-7+b2                                         armel        high-quality block-sorting file compressor library - runtime
...
ii  libdb5.3:armel                        5.3.28-7~deb8u1                                    armel        Berkeley v5.3 Database Libraries [runtime]
ii  libdbus-1-3:armel                     1.8.12-3                                           armel        simple interprocess messaging system (library)
...
ii  libdns-export100                      1:9.9.5.dfsg-8                                     armel        Exported DNS Shared Library
...
ii  libgcrypt20:armel                     1.6.2-4+b1                                         armel        LGPL Crypto library - runtime library
...
ii  libgssapi-krb5-2:armel                1.12.1+dfsg-18                                     armel        MIT Kerberos runtime libraries - krb5 GSS-API Mechanism
ii  libgssapi3-heimdal:armel              1.6~rc2+dfsg-9                                     armel        Heimdal Kerberos - GSSAPI support library
ii  libgudev-1.0-0:armel                  215-11                                             armel        GObject-based wrapper library for libudev
...
ii  libicu52:armel                        52.1-7.1                                           armel        International Components for Unicode
ii  libidn11:armel                        1.29-1+b2                                          armel        GNU Libidn library, implementation of IETF IDN specifications
ii  libirs-export91                       1:9.9.5.dfsg-8                                     armel        Exported IRS Shared Library
ii  libisc-export95                       1:9.9.5.dfsg-8                                     armel        Exported ISC Shared Library
ii  libisccfg-export90                    1:9.9.5.dfsg-8                                     armel        Exported ISC CFG Shared Library
ii  libjbig0:armel                        2.1-3.1                                            armel        JBIGkit libraries
ii  libjpeg62-turbo:armel                 1:1.3.1-11                                         armel        libjpeg-turbo JPEG runtime library
...
ii  libk5crypto3:armel                    1.12.1+dfsg-18                                     armel        MIT Kerberos runtime libraries - Crypto Library
...
ii  libkrb5-3:armel                       1.12.1+dfsg-18                                     armel        MIT Kerberos runtime libraries
ii  libkrb5support0:armel                 1.12.1+dfsg-18                                     armel        MIT Kerberos runtime libraries - Support library
ii  libldap-2.4-2:armel                   2.4.40-4                                           armel        OpenLDAP libraries
...
ii  libmount1:armel                       2.25.2-5                                           armel        device mounting library
...
ii  libpython-stdlib:armel                2.7.8-3                                            armel        interactive high-level object-oriented language (default python version)
...
ii  libruby2.1:armel                      2.1.5-1                                            armel        Libraries necessary to run Ruby 2.1
...
ii  libsmartcols1:armel                   2.25.2-5                                           armel        smart column output alignment library
...
ii  libssl-dev:armel                      1.0.1k-1                                           armel        Secure Sockets Layer toolkit - development files
ii  libssl1.0.0:armel                     1.0.1k-1                                           armel        Secure Sockets Layer toolkit - shared libraries
ii  libstdc++6:armel                      4.9.1-19                                           armel        GNU Standard C++ Library v3
ii  libsystemd0:armel                     215-11                                             armel        systemd utility library
...
ii  libtiff5:armel                        4.0.3-12                                           armel        Tag Image File Format (TIFF) library
...
ii  libudev1:armel                        215-11                                             armel        libudev shared library
...
ii  libuuid1:armel                        2.25.2-5                                           armel        Universally Unique ID library
...
ii  linux-image-3.16.7-ckt6-ev3dev1       1                                                  armel        Linux kernel binary image for version 3.16.7-ckt6-ev3dev1
ii  linux-image-ev3dev                    17                                                 armel        Linux kernel for ev3dev (meta-package)
ii  linux-libc-dev:armel                  3.16.7-ckt4-3                                      armel        Linux support headers for userspace development
...
ii  mount                                 2.25.2-5                                           armel        Tools for mounting and manipulating filesystems
...
ii  nodejs                                0.10.29~dfsg-1.1                                   armel        evented I/O for V8 javascript
ii  nodejs-dev                            0.10.29~dfsg-1.1                                   armel        evented I/O for V8 javascript (development files)
ii  nodejs-legacy                         0.10.29~dfsg-1.1                                   all          evented I/O for V8 javascript (legacy symlink)
ii  npm                                   1.4.21+ds-2                                        all          package manager for Node.js
ii  ntp                                   1:4.2.6.p5+dfsg-5                                  armel        Network Time Protocol daemon and utility programs
...
ii  openssl                               1.0.1k-1                                           armel        Secure Sockets Layer toolkit - cryptographic utility
ii  parted                                3.2-6                                              armel        disk partition manipulator
ii  passwd                                1:4.2-3                                            armel        change and administer password and group data
ii  perl                                  5.20.1-5                                           armel        Larry Wall's Practical Extraction and Report Language
ii  perl-base                             5.20.1-5                                           armel        minimal Perl system
ii  perl-modules                          5.20.1-5                                           all          Core Perl modules
ii  plymouth                              0.9.0-9ev3dev1                                     armel        boot animation, logger and I/O multiplexer
ii  procps                                2:3.3.9-8                                          armel        /proc file system utilities
ii  psmisc                                22.21-2                                            armel        utilities that use the proc file system
ii  python                                2.7.8-3                                            armel        interactive high-level object-oriented language (default version)
...
ii  python-minimal                        2.7.8-3                                            armel        minimal subset of the Python language (default version)
...
ii  rtl8188eu-modules-3.16.7-ckt6-ev3dev1 3+1                                                armel        rtl8188eu modules for Linux (kernel 3.16.7-ckt6-ev3dev1).
ii  rtl8192cu-modules-3.16.7-ckt6-ev3dev1 4.0.2-9000.20131029-0ev3dev5+1                     armel        rtl8192cu series modules for Linux (kernel 3.16.7-ckt6-ev3dev1).
ii  rtl8192cu-modules-common              4.0.2-9000.20131029-0ev3dev5+1+3.16.7-ckt6-ev3dev1 all          rtl8192cu series modules for Linux.
ii  ruby                                  1:2.1.0.4                                          all          Interpreter of object-oriented scripting language Ruby (default version)
ii  ruby2.1                               2.1.5-1                                            armel        Interpreter of object-oriented scripting language Ruby
...
ii  sudo                                  1.8.10p3-1+deb8u1                                  armel        Provide limited super user privileges to specific users
ii  systemd                               215-11                                             armel        system and service manager
ii  systemd-sysv                          215-11                                             armel        system and service manager - SysV links
...
ii  udev                                  215-11                                             armel        /dev/ and hotplug management daemon
ii  usbutils                              1:007-2                                            armel        Linux USB utilities
ii  util-linux                            2.25.2-5                                           armel        Miscellaneous system utilities
ii  vim                                   2:7.4.488-4                                        armel        Vi IMproved - enhanced vi editor
ii  vim-common                            2:7.4.488-4                                        armel        Vi IMproved - Common files
