Release notes for ev3-ev3dev-jessie-2015-12-30.img
==============================================
...
* ev3dev kernel 3.16.7-ckt21-9-ev3dev-ev3
* Updated ev3dev packages
* New packages: evtest, fbset, firmware-linux-free, openrobertalab, python-ev3dev, python-evdev,
  python-setuptools, zram-init
...
ii  apt                                         1.0.9.8.1                armel        commandline package manager
...
ii  bind9-host                                  1:9.9.5.dfsg-9+deb8u2    armel        Version of 'host' bundled with BIND 9.X
ii  bluez                                       5.23-2+b1                armel        Bluetooth tools and daemons
ii  brickman                                    0.7.2                    armel        ev3dev Brick Manager
...
ii  connman                                     1.31-0ev3dev1            armel        Intel Connection Manager daemon
...
ii  ev3-systemd                                 5.1.0                    armel        Systemd unit files and udev rules for LEGO MINDSTORMS EV3.
...
ii  flash-kernel                                3.35ev3dev5              armel        utility to make certain embedded devices bootable
ii  fonts-tom-thumb                             1                        all          Very tiny, monospace, bitmap font.
ii  fuse                                        2.9.3-15+deb8u1          armel        Filesystem in Userspace
...
ii  libapt-pkg4.12:armel                        1.0.9.8.1                armel        package management runtime library
...
ii  libbind9-90                                 1:9.9.5.dfsg-9+deb8u2    armel        BIND9 Shared Library used by BIND
ii  libblkid1:armel                             2.25.2-6                 armel        block device id library
ii  libbluetooth3:armel                         5.23-2+b1                armel        Library to use the BlueZ Linux Bluetooth stack
...
ii  libc-bin                                    2.19-18+deb8u1           armel        GNU C Library: Binaries
ii  libc-dev-bin                                2.19-18+deb8u1           armel        GNU C Library: Development binaries
ii  libc6:armel                                 2.19-18+deb8u1           armel        GNU C Library: Shared libraries
ii  libc6-dev:armel                             2.19-18+deb8u1           armel        GNU C Library: Development Libraries and Header Files
...
ii  libdns-export100                            1:9.9.5.dfsg-9+deb8u2    armel        Exported DNS Shared Library
ii  libdns100                                   1:9.9.5.dfsg-9+deb8u2    armel        DNS Shared Library used by BIND
...
ii  libev3devkit-0.3-0                          0.3.1                    armel        Programming toolkit for ev3dev
ii  libevent-2.0-5:armel                        2.0.21-stable-2          armel        Asynchronous event notification library
ii  libexpat1:armel                             2.1.0-6+deb8u1           armel        XML parsing C library - runtime library
...
ii  libfreetype6:armel                          2.5.2-3                  armel        FreeType 2 font engine, shared library files
ii  libfuse2:armel                              2.9.3-15+deb8u1          armel        Filesystem in Userspace (library)
...
ii  libgudev-1.0-0:armel                        215-17+deb8u2            armel        GObject-based wrapper library for libudev
...
ii  libicu52:armel                              52.1-8+deb8u2            armel        International Components for Unicode
ii  libidn11:armel                              1.29-1+b2                armel        GNU Libidn library, implementation of IETF IDN specifications
ii  libirs-export91                             1:9.9.5.dfsg-9+deb8u2    armel        Exported IRS Shared Library
ii  libisc-export95                             1:9.9.5.dfsg-9+deb8u2    armel        Exported ISC Shared Library
ii  libisc95                                    1:9.9.5.dfsg-9+deb8u2    armel        ISC Shared Library used by BIND
ii  libisccc90                                  1:9.9.5.dfsg-9+deb8u2    armel        Command Channel Library used by BIND
ii  libisccfg-export90                          1:9.9.5.dfsg-9+deb8u2    armel        Exported ISC CFG Shared Library
ii  libisccfg90                                 1:9.9.5.dfsg-9+deb8u2    armel        Config File Handling Library used by BIND
...
ii  liblwres90                                  1:9.9.5.dfsg-9+deb8u2    armel        Lightweight Resolver Library used by BIND
...
ii  libpam-systemd:armel                        215-17+deb8u2            armel        system and service manager - PAM module
...
ii  libruby2.1:armel                            2.1.5-2+deb8u2           armel        Libraries necessary to run Ruby 2.1
...
ii  libsqlite3-0:armel                          3.8.7.1-1+deb8u1         armel        SQLite 3 shared library
ii  libss2:armel                                1.42.12-1.1              armel        command-line interface parsing library
ii  libssl-dev:armel                            1.0.1k-3+deb8u1          armel        Secure Sockets Layer toolkit - development files
ii  libssl1.0.0:armel                           1.0.1k-3+deb8u1          armel        Secure Sockets Layer toolkit - shared libraries
ii  libstdc++6:armel                            4.9.2-10                 armel        GNU Standard C++ Library v3
ii  libsystemd0:armel                           215-17+deb8u2            armel        systemd utility library
ii  libtalloc2:armel                            2.1.1-2                  armel        hierarchical pool based memory allocator
ii  libtasn1-6:armel                            4.2-3+deb8u1             armel        Manage ASN.1 structures (runtime)
...
ii  libudev1:armel                              215-17+deb8u2            armel        libudev shared library
...
ii  linux-image-3.16.7-ckt21-9-ev3dev-ev3       1                        armel        Linux kernel binary image for version 3.16.7-ckt21-9-ev3dev-ev3
ii  linux-image-ev3dev-ev3                      24                       armel        Linux kernel for ev3dev (meta-package)
ii  linux-libc-dev:armel                        3.16.7-ckt11-1+deb8u3    armel        Linux support headers for userspace development
...
ii  multiarch-support                           2.19-18+deb8u1           armel        Transitional package to ensure multiarch compatibility
...
ii  openssl                                     1.0.1k-3+deb8u1          armel        Secure Sockets Layer toolkit - cryptographic utility
ii  parted                                      3.2-7                    armel        disk partition manipulator
ii  passwd                                      1:4.2-3                  armel        change and administer password and group data
ii  perl                                        5.20.2-3+deb8u1          armel        Larry Wall's Practical Extraction and Report Language
ii  perl-base                                   5.20.2-3+deb8u1          armel        minimal Perl system
...
ii  python-bluez                                0.20-1                   armel        Python wrappers around BlueZ for rapid bluetooth development
...
ii  python-pil:armel                            2.6.1-2                  armel        Python Imaging Library (Pillow fork)
...
ii  rtl8188eu-modules-3.16.7-ckt21-9-ev3dev-ev3 5+1                      armel        rtl8188eu modules for Linux (kernel 3.16.7-ckt21-9-ev3dev-ev3).
ii  ruby                                        1:2.1.5+deb8u1           all          Interpreter of object-oriented scripting language Ruby (default version)
ii  ruby2.1                                     2.1.5-2+deb8u2           armel        Interpreter of object-oriented scripting language Ruby
...
ii  systemd                                     215-17+deb8u2            armel        system and service manager
ii  systemd-sysv                                215-17+deb8u2            armel        system and service manager - SysV links
...
ii  udev                                        215-17+deb8u2            armel        /dev/ and hotplug management daemon
...
ii  wpasupplicant                               2.3-1+deb8u1             armel        client support for WPA and WPA2 (IEEE 802.11i)
...
ii  zram-init                                   3.5ev3dev1               all          Wrapper script for the zram kernel module with interactive and init support.
```
