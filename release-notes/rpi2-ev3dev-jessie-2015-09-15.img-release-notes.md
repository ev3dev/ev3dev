Release notes for rpi2-ev3dev-jessie-2015-09-15.img
==============================================

Changes from previous version
-----------------------------
* Updated kernel.
* Updated packates from Debian 8.1 and 8.2 point releases.
* Added bluez and i2c-tools packages.
...
* qemu-user 2.0.0+dfsg-2ubuntu1.18
...
ii  brickpi-systemd                 2                                 all          Udev rule and systemd service for BrickPi.
ii  bsdutils                        1:2.25.2-6                        armhf        basic utilities from 4.4BSD-Lite
ii  ca-certificates                 20141019                          all          Common CA certificates
ii  connman                         1.30-0ev3dev1                     armhf        Intel Connection Manager daemon
...
ii  flash-kernel                    3.35ev3dev2                       armhf        utility to make certain embedded devices bootable
...
ii  golang-go                       2:1.3.3-1                         armhf        Go programming language compiler
ii  golang-go-linux-arm             2:1.3.3-1                         armhf        Go standard library compiled for linux_arm
ii  golang-src                      2:1.3.3-1                         armhf        Go programming language compiler - source files
...
ii  libraspberrypi-bin              1.20150914-1ev3dev1               armhf        Miscellaneous Raspberry Pi utilities
ii  libraspberrypi0                 1.20150914-1ev3dev1               armhf        EGL/GLES/OpenVG/etc. libraries for the Raspberry Pi's VideoCore IV
...
ii  linux-image-4.1.7-7-ev3dev-rpi2 1                                 armhf        Linux kernel binary image for version 4.1.7-7-ev3dev-rpi2
ii  linux-image-ev3dev-rpi2         2                                 armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
...
ii  raspberrypi-bootloader          1.20150914-1ev3dev1               armhf        Raspberry Pi bootloader
