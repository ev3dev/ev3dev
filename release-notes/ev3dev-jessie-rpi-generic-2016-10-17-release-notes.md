Release notes for ev3dev-jessie-rpi-generic-2016-10-17.img
==========================================================

Changes from previous version
-----------------------------
* ev3dev kernel 4.4.23-16-ev3dev-rpi
    * Includes breaking motor driver changes - see [announcement][kernel-10] for details
    * Many other bug fixes and new drivers enabled
* Additional packages installed by default: `fake-hwclock`, `fortune-mod`, `git`,
  `python3-ev3dev`, `python3-libpixyusb`
* Dropped package: `locales`

[kernel-10]: http://www.ev3dev.org/news/2016/04/11/Kernel-Release-Cycle-10
...
ii  bind9-host                       1:9.9.5.dfsg-9+deb8u7             armhf        Version of 'host' bundled with BIND 9.X
ii  bluez                            5.23-2ev3dev2                     armhf        Bluetooth tools and daemons
ii  brickman                         0.8.0                             armhf        ev3dev Brick Manager
...
ii  flash-kernel                     3.35ev3dev13                      armhf        utility to make certain embedded devices bootable
...
ii  libbind9-90                      1:9.9.5.dfsg-9+deb8u7             armhf        BIND9 Shared Library used by BIND
...
ii  libc-dev-bin                     2.19-18+deb8u6                    armhf        GNU C Library: Development binaries
ii  libc6:armhf                      2.19-18+deb8u6                    armhf        GNU C Library: Shared libraries
ii  libc6-dev:armhf                  2.19-18+deb8u6                    armhf        GNU C Library: Development Libraries and Header Files
...
ii  libcurl3-gnutls:armhf            7.38.0-4+deb8u4                   armhf        easy-to-use client-side URL transfer library (GnuTLS flavour)
...
ii  libdns-export100                 1:9.9.5.dfsg-9+deb8u7             armhf        Exported DNS Shared Library
ii  libdns100                        1:9.9.5.dfsg-9+deb8u7             armhf        DNS Shared Library used by BIND
...
ii  libev3devkit-0.4-0               0.4.2                             armhf        Programming toolkit for ev3dev
...
ii  libgudev-1.0-0:armhf             215-17+deb8u5                     armhf        GObject-based wrapper library for libudev
...
ii  libhogweed2:armhf                2.7.1-5+deb8u1                    armhf        low level cryptographic library (public-key cryptos)
...
ii  libirs-export91                  1:9.9.5.dfsg-9+deb8u7             armhf        Exported IRS Shared Library
ii  libisc-export95                  1:9.9.5.dfsg-9+deb8u7             armhf        Exported ISC Shared Library
ii  libisc95                         1:9.9.5.dfsg-9+deb8u7             armhf        ISC Shared Library used by BIND
ii  libisccc90                       1:9.9.5.dfsg-9+deb8u7             armhf        Command Channel Library used by BIND
ii  libisccfg-export90               1:9.9.5.dfsg-9+deb8u7             armhf        Exported ISC CFG Shared Library
ii  libisccfg90                      1:9.9.5.dfsg-9+deb8u7             armhf        Config File Handling Library used by BIND
...
ii  liblcms2-2:armhf                 2.6-3                             armhf        Little CMS 2 color management library
...
ii  liblwres90                       1:9.9.5.dfsg-9+deb8u7             armhf        Lightweight Resolver Library used by BIND
...
ii  libnettle4:armhf                 2.7.1-5+deb8u1                    armhf        low level cryptographic library (symmetric and one-way cryptos)
...
ii  libpam-systemd:armhf             215-17+deb8u5                     armhf        system and service manager - PAM module
...
ii  libraspberrypi-bin               1.20161004-1ev3dev1               armhf        Miscellaneous Raspberry Pi utilities
ii  libraspberrypi0                  1.20161004-1ev3dev1               armhf        EGL/GLES/OpenVG/etc. libraries for the Raspberry Pi's VideoCore IV
...
ii  librtmp1:armhf                   2.4+20150115.gita107cef-1         armhf        toolkit for RTMP streams (shared library)
...
ii  libsmbclient:armhf               2:4.2.10+dfsg-0+deb8u3            armhf        shared library for communication with SMB/CIFS servers
...
ii  libssl-dev:armhf                 1.0.1t-1+deb8u5                   armhf        Secure Sockets Layer toolkit - development files
...
ii  libsystemd0:armhf                215-17+deb8u5                     armhf        systemd utility library
...
ii  libtevent0:armhf                 0.9.25-0+deb8u1                   armhf        talloc-based event loop library - shared library
...
ii  libudev1:armhf                   215-17+deb8u5                     armhf        libudev shared library
...
ii  libwbclient0:armhf               2:4.2.10+dfsg-0+deb8u3            armhf        Samba winbind client library
...
ii  libxml2:armhf                    2.9.1+dfsg1-5+deb8u3              armhf        GNOME XML library
...
ii  linux-image-4.4.23-16-ev3dev-rpi 1                                 armhf        Linux kernel binary image for version 4.4.23-16-ev3dev-rpi
ii  linux-image-ev3dev-rpi           13                                armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
...
ii  multiarch-support                2.19-18+deb8u6                    armhf        Transitional package to ensure multiarch compatibility
...
ii  python-bluez                     0.22-1ev3dev1                     armhf        Python wrappers around BlueZ for rapid bluetooth development
ii  python-crypto                    2.6.1-5                           armhf        cryptographic algorithms and protocols for Python
...
ii  python-pil:armhf                 2.6.1-2+deb8u2                    armhf        Python Imaging Library (Pillow fork)
...
ii  python3-ev3dev                   0.7.0                             all          Python language bindings for ev3dev
...
ii  python3-pil:armhf                2.6.1-2+deb8u2                    armhf        Python Imaging Library (Python3)
...
ii  raspberrypi-bootloader           1.20161004-1ev3dev1               armhf        Raspberry Pi bootloader
...
ii  samba                            2:4.2.10+dfsg-0+deb8u3            armhf        SMB/CIFS file, print, and login server for Unix
...
ii  samba-dsdb-modules               2:4.2.10+dfsg-0+deb8u3            armhf        Samba Directory Services Database
...
ii  systemd                          215-17+deb8u5                     armhf        system and service manager
ii  systemd-sysv                     215-17+deb8u5                     armhf        system and service manager - SysV links
...
ii  udev                             215-17+deb8u5                     armhf        /dev/ and hotplug management daemon
