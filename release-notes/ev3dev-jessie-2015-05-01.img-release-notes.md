Release notes for ev3dev-jessie-2015-05-01.img
==============================================

Changes from previous version
-----------------------------

* Image size is now ~2GB.
* Uses single ext4 patition instead of LVM with ext3 and swap partitions.
* New packages: avahi-daemon, dphys-swapfile, libnss-mdsn, libnss-winbind, libpam-systemd, samba
* Removed packages: lvm, plymouth

Known issues
------------

* Bluetooth may not work on first boot.
* First shutdown/reboot seems to take longer than it should.
...
ii  brickman                                    0.6.0                    armel        ev3dev Brick Manager
...
ii  ev3dev-base                                 9.0                      armel        Meta package that installs all of the required ev3dev packages.
ii  ev3dev-bluetooth                            9.0                      armel        Firmware and scripts for EV3 bluetooth.
ii  ev3dev-connman-config                       1                        all          ev3dev-specific configuration files for connman
ii  ev3dev-console                              9.0                      armel        Console related configuration files and console fonts.
ii  ev3dev-flash-kernel                         9.0                      armel        Database entry and boot script for flash-kernel.
ii  ev3dev-gadget                               9.0                      armel        systemd services for starting/stopping USB Ethernet gadget modules.
ii  ev3dev-i2c                                  9.0                      armel        Udev rules for I2C devices.
ii  ev3dev-leds                                 9.0                      armel        Initialization scripts for EV3 LEDs.
ii  ev3dev-ports                                9.0                      armel        Scripts related to the EV3 input and output ports
ii  ev3dev-uart                                 9.0                      armel        Firmware and scripts for EV3 input port UARTs.
...
ii  flash-kernel                                3.35                     armel        utility to make certain embedded devices bootable
...
ii  libnss-winbind:armel                        2:4.1.17+dfsg-2          armel        Samba nameservice integration plugins
...
ii  linux-image-3.16.7-ckt10-4-ev3dev-ev3       1                        armel        Linux kernel binary image for version 3.16.7-ckt10-4-ev3dev-ev3
ii  linux-image-ev3dev-ev3                      19                       armel        Linux kernel for ev3dev (meta-package)
...
ii  rtl8188eu-modules-3.16.7-ckt10-4-ev3dev-ev3 4~1+1                    armel        rtl8188eu modules for Linux (kernel 3.16.7-ckt10-4-ev3dev-ev3).
...
ii  winbind                                     2:4.1.17+dfsg-2          armel        service to resolve user and group information from Windows NT servers
