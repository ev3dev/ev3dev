Release notes for ev3dev-jessie-rpi-generic-2017-02-11
========================================

Changes from previous version
-----------------------------
* ev3dev kernel 4.4.47-19-ev3dev-rpi
* BrickPi3 support
* New gattlib packages for BLE (Bluetooth Low Energy)
* Python Tool for Visual Studio packages for remote debugging


Known issues
------------
* No serious known issues
...
ii  bind9-host                       1:9.9.5.dfsg-9+deb8u9             armhf        Version of 'host' bundled with BIND 9.X
...
ii  libbind9-90                      1:9.9.5.dfsg-9+deb8u9             armhf        BIND9 Shared Library used by BIND
...
ii  libdns-export100                 1:9.9.5.dfsg-9+deb8u9             armhf        Exported DNS Shared Library
ii  libdns100                        1:9.9.5.dfsg-9+deb8u9             armhf        DNS Shared Library used by BIND
...
ii  libgudev-1.0-0:armhf             215-17+deb8u6                     armhf        GObject-based wrapper library for libudev
...
ii  libirs-export91                  1:9.9.5.dfsg-9+deb8u9             armhf        Exported IRS Shared Library
ii  libisc-export95                  1:9.9.5.dfsg-9+deb8u9             armhf        Exported ISC Shared Library
ii  libisc95                         1:9.9.5.dfsg-9+deb8u9             armhf        ISC Shared Library used by BIND
ii  libisccc90                       1:9.9.5.dfsg-9+deb8u9             armhf        Command Channel Library used by BIND
ii  libisccfg-export90               1:9.9.5.dfsg-9+deb8u9             armhf        Exported ISC CFG Shared Library
ii  libisccfg90                      1:9.9.5.dfsg-9+deb8u9             armhf        Config File Handling Library used by BIND
...
ii  liblwres90                       1:9.9.5.dfsg-9+deb8u9             armhf        Lightweight Resolver Library used by BIND
...
ii  libpam-systemd:armhf             215-17+deb8u6                     armhf        system and service manager - PAM module
...
ii  libtiff5:armhf                   4.0.3-12.3+deb8u2                 armhf        Tag Image File Format (TIFF) library
...
ii  linux-image-4.4.47-19-ev3dev-rpi 1                                 armhf        Linux kernel binary image for version 4.4.47-19-ev3dev-rpi
ii  linux-image-ev3dev-rpi           16                                armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
