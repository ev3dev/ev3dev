Release notes for rpi2-ev3dev-jessie-2015-05-19.img
==============================================
...
ii  fuse                              2.9.3-15+b1                       armhf        Filesystem in Userspace
...
ii  libexpat1:armhf                   2.1.0-6+b3                        armhf        XML parsing C library - runtime library
...
ii  libfuse2:armhf                    2.9.3-15+b1                       armhf        Filesystem in Userspace (library)
...
ii  libruby2.1:armhf                  2.1.5-2                           armhf        Libraries necessary to run Ruby 2.1
...
ii  libsqlite3-0:armhf                3.8.7.1-1                         armhf        SQLite 3 shared library
...
ii  libtasn1-6:armhf                  4.2-3                             armhf        Manage ASN.1 structures (runtime)
...
ii  linux-image-3.18.13-5-ev3dev-rpi2 1                                 armhf        Linux kernel binary image for version 3.18.13-5-ev3dev-rpi2
ii  linux-image-ev3dev-rpi2           1                                 armhf        Linux kernel for ev3dev on Raspberry Pi (meta-package)
ii  linux-libc-dev:armhf              3.16.7-ckt9-2                     armhf        Linux support headers for userspace development
...
ii  ruby2.1                           2.1.5-2                           armhf        Interpreter of object-oriented scripting language Ruby
...
ii  wpasupplicant                     2.3-1                             armhf        client support for WPA and WPA2 (IEEE 802.11i)
